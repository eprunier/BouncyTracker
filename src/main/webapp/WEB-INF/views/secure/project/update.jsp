...
<html>
<head>
	<title><fmt:message key="page.secure.project.update.title" /></title>
</head>
<body>

	<h1><fmt:message key="page.secure.project.update.title" /></h1>
	<c:url value="/secure/project/update" var="formAction" />
	<form:form commandName="project" action="${formAction}">
		<form:hidden path="id" />
		...
		<table>
			<tbody>
				<tr class="odd prop">
					...
					<td class="value"><form:input path="name" size="30" /></td>
